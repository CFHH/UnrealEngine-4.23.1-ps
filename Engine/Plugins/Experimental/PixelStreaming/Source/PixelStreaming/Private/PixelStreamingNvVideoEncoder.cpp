...
private:
	...
	struct FRHITransferRenderTargetToNvEnc final : public FRHICommand<FRHITransferRenderTargetToNvEnc>
	{
		...
		FORCEINLINE_DEBUGGABLE FRHITransferRenderTargetToNvEnc(FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl* InEncoder, FFrame* InFrame)
...
public:
	FPixelStreamingNvVideoEncoderImpl(void* DllHandle, const FVideoEncoderSettings& Settings, const FTexture2DRHIRef& BackBuffer, bool bEnableAsyncMode, const FEncodedFrameReadyCallback& InEncodedFrameReadyCallback);
	~FPixelStreamingNvVideoEncoderImpl();
...
FThreadSafeCounter FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::ImplCounter(0);
...
*/
FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::FPixelStreamingNvVideoEncoderImpl(void* DllHandle, const FVideoEncoderSettings& Settings, const FTexture2DRHIRef& BackBuffer, bool bEnableAsyncMode, const FEncodedFrameReadyCallback& InEncodedFrameReadyCallback)
...
FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::~FPixelStreamingNvVideoEncoderImpl()
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::UpdateSpsPpsHeader()
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::UpdateSettings(const FVideoEncoderSettings& Settings, const FTexture2DRHIRef& BackBuffer)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::CopyBackBuffer(const FTexture2DRHIRef& BackBuffer, const FTexture2DRHIRef& ResolvedBackBuffer)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::EncoderCheckLoop()
{
	int CurrentIndex = 0;
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::EncodeFrame(const FVideoEncoderSettings& Settings, const FTexture2DRHIRef& BackBuffer, uint64 CaptureMs)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::TransferRenderTargetToHWEncoder(FFrame& Frame)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::ProcessFrame(FFrame& Frame)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::InitializeResources(const FTexture2DRHIRef& BackBuffer)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::ReleaseFrameInputBuffer(FFrame& Frame)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::ReleaseResources()
{
	for (uint32 i = 0; i < NumBufferedFrames; ++i)
	{
		FFrame& Frame = BufferedFrames[i];
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::RegisterAsyncEvent(void** OutEvent)
{
...
void FPixelStreamingNvVideoEncoder::FPixelStreamingNvVideoEncoderImpl::UnregisterAsyncEvent(void* Event)
{
	if (Event)
	{
		NV_ENC_EVENT_PARAMS EventParams;
...
bool FPixelStreamingNvVideoEncoder::IsSupported() const
{
	return DllHandle && NvVideoEncoderImpl->IsSupported();
}

bool FPixelStreamingNvVideoEncoder::IsAsyncEnabled() const
{
	return NvVideoEncoderImpl->IsAsyncEnabled();
}

void FPixelStreamingNvVideoEncoder::EncodeFrame(const FVideoEncoderSettings& Settings, const FTexture2DRHIRef& BackBuffer, uint64 CaptureMs)
{
	NvVideoEncoderImpl->EncodeFrame(Settings, BackBuffer, CaptureMs);
}

const TArray<uint8>& FPixelStreamingNvVideoEncoder::GetSpsPpsHeader() const
{
	return NvVideoEncoderImpl->GetSpsPpsHeader();
}

void FPixelStreamingNvVideoEncoder::ForceIdrFrame()
{
